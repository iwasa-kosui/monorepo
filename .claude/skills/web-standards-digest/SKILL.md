...
Web標準・ランタイム・サーバサイドTSエコシステムの直近1ヶ月の動向を調査し、kosui.me の Weekly Tech Digest 記事（private）として出力する。
...
`apps/kosui-me/src/content/posts/{DATE}-weekly-tech-digest.mdx`
