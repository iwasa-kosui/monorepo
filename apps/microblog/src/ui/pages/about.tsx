...
export const AboutPage = ({ lang }: Props) => {
  ...
  return (
    ...
    >
      <section class='space-y-6'>
        {/* Header */}
        <div class='bg-white dark:bg-gray-800 rounded-3xl shadow-puffy dark:shadow-puffy-dark p-8'>
        ...
        <div class='bg-white dark:bg-gray-800 rounded-3xl shadow-puffy dark:shadow-puffy-dark p-8'>
          ...
          <div class='grid gap-4 sm:grid-cols-2'>
            {t.features.map((feature) => (
              <div
                key={feature.title}
                class='bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 transition-transform hover:scale-[1.02]'
              >
        ...
        <div class='bg-white dark:bg-gray-800 rounded-3xl shadow-puffy dark:shadow-puffy-dark p-8'>
          ...
          <div class='space-y-3'>
            {t.techStack.map((tech) => (
              <div
                key={tech.name}
                class='flex items-start gap-3 bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-3'
              >
                <span class='font-medium text-gray-700 dark:text-gray-300 min-w-24'>
                  {tech.name}
                </span>
                <span class='text-gray-500 dark:text-gray-400'>{tech.value}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div class='bg-white dark:bg-gray-800 rounded-3xl shadow-puffy dark:shadow-puffy-dark p-8'>
          ...
          <a
            ...
            class='inline-flex items-center gap-2 px-5 py-2.5 bg-gray-700 hover:bg-gray-600 text-white font-medium rounded-2xl transition-colors'
          >
