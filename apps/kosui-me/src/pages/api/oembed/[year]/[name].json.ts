...
export const GET: APIRoute = ({ props }) => {
  ...
  const embedUrl = presentation.slideType === 'local'
    ? `${SITE_URL}/slides${presentation.basePath}?embedded=true&controls=true`
  ...
  const oembedResponse = {
    ...
    height: 540,
    html:
      `<iframe src="${embedUrl}" width="960" height="540" style="border:0;aspect-ratio:16/9;width:100%;height:auto;" title="${
