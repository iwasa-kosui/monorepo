...
describe('createOnDelete', () => {
  it('removes every post reference before deleting the remote post', async () => {
    ...
    await createOnDelete(deps)({} as never, { objectId: new URL('https://remote.example/posts/1') } as never);
