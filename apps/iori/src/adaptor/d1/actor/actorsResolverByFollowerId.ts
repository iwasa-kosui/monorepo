...
import type { Actor, ActorsResolverByFollowerId } from '../../../domain/actor/actor.ts';
...
export const createD1ActorsResolverByFollowerId = (db: IoriD1Db): ActorsResolverByFollowerId => ({
  resolve: async (followerId) => {
