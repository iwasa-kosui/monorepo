...
カケハシは調剤薬局向けSaaSを中心に医療現場のDXを推進している企業で、4つ以上のプロダクトを開発・運用しており、すべてが患者情報を扱います。
私たちのチームは認証ポータル、ディレクトリサービス、アセットサービスという3つの基盤システムを担当しており、これらは社内の複数プロダクトから利用される共通基盤です。
厚生労働省・経済産業省・総務省が定めた医療情報の安全管理に関するガイドライン、いわゆる3省2ガイドラインへの準拠が求められます。
-->
