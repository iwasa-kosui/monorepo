...
<CardGrid :cols="2">
  ...
  >
    <ul>
      <li class="text-green-600">✓ 専門知識・ベストプラクティスの活用</li>
      <li>チーム規模に対して協働が難しい</li>
      <li>コンテキスト共有の負担増</li>
    </ul>
  </OptionCard>
  <OptionCard
    ...
    >
    <ul>
      <li class="text-green-600">✓ 深い理解と迅速な改善が可能</li>
      <li class="text-green-600">✓ コンテキストが集約される</li>
      <li>専門的なSRE知見の習得が必要</li>
    </ul>
  </OptionCard>
</CardGrid>
...
ここで2つの選択肢がありました。
選択肢Aは、Embedded SREを採用すること。専門知識やベストプラクティスを活用できるメリットがある一方、小規模なチームでは十分な協働が難しく、コンテキスト共有の負担も増えます。
選択肢Bは、開発チーム自身が設計・実装・運用を一貫して担うこと。深い理解と迅速な改善が可能で、コンテキストが集約されます。ただし、専門的なSRE知見を自分たちで習得する必要があります。
