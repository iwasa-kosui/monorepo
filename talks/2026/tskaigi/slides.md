...
同じコードでも tsconfig の  `useDefineForClassFields` で挙動が変わる
...
- Microsoft は既に IE でブラウザ戦争に勝利し  
  Flash と競争関係にある Silverlight の開発に集中  
  JScript 言語が動作する .NET ランタイムとの相互運用性を重視し反対
