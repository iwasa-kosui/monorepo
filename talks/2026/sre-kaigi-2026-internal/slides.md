...
- 社内の**複数プロダクトから利用**される共通基盤 — 止まると全プロダクトに影響
- Embedded SREは不在、開発チーム自身が**信頼性に責任を持つ**

<!--
簡単にチームの紹介です。認証権限基盤チームは、認証基盤・ID基盤・ライセンス基盤・端末証明書基盤の4つを担当しています。これらは社内の複数プロダクトから利用される共通基盤で、止まると全プロダクトに影響します。そしてEmbedded SREは不在のため、開発チーム自身が信頼性に責任を持っています。
-->
